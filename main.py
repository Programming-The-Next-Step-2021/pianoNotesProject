    ...
    def run(self):
        ...
        while True:
            if self.input.poll():
                ...
                key_id, key_sensitivity = midi_key[0][1], midi_key[0][2]
...
class MainWindow(QMainWindow):
    ...
    def read_data_and_order(self):
        ...
        self.note_widget.setPixmap(QPixmap("./piano_package/Notes/" + self.notes[0]))
    ...
    def test_input(self, s):
        ...
        self.note_widget.setPixmap(
            QPixmap("./piano_package/Notes/" + self.notes[self.i])
        )
